...
(() => {
  ...
  class Seed {
    ...
    drawText = () => {
      ...
      ctx.fillText("From Hunk Mike With Big Luv <3", 23, 10);
      ctx.restore();
    };
    ...
    clear = () => {
      ...
      const textX = point.x + 15 * scale;
      const textY = point.y + 15 * scale;
      const textWidth = 200 * scale;
      const textHeight = 20 * scale;
      ctx.clearRect(textX - 10, textY - textHeight, textWidth + 20, textHeight + 10);
    };
